...
版本信息如以下：react-native：0.72.5；react-native-harmony: 0.72.27；DevEco Studio: 5.0.3.400；SDK: HarmonyOS NEXT Developer Beta1；ROM: 3.0.0.25
...
2.目前notificationSuccess，notificationWarning，notificationError，effectDoubleClick多次振动方法，由于当前版本问题不支持，只能提供振动次数和振动间隔无法控制振感（默认强度100）
## 其他
